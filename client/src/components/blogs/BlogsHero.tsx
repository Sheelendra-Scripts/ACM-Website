      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        >
          <div className="max-w-[1400px] mx-auto w-full">
            ...
            >
              <span className="text-white">Ideas</span> that inspire.{" "}
              <span className="text-white">Stories</span> that resonate.
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-300">10+ Stories</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-300">Tech & Beyond</p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-300">ACM Community</p>
              </div>
